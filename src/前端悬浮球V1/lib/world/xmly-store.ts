// 世界套件 —— 喜马拉雅（xmly）数据层（xmly-store.ts）
// 仙宫版「喜马拉雅 / 荔枝 FM」：**纯音频**世界——有声书 / 广播剧 / 国风音乐 / 助眠ASMR / 知识播客 /
//   情感夜话 / 修真引导音 / 深夜连麦电台。与糖心(视觉直播)、B站(视频)明确错开：这里是「闭眼听」。
// 玩家＝纯听众：只听/追更/连麦打进热线/点歌/投声音树洞——不自己开台、不录有声书（开播戏留糖心）。
// 核心差异化＝「常驻底部播放条」：播放态存 store，切 tab/切专辑不中断。
// 世界观锚点：谪仙宫(演艺/戏剧)出节目源，听风宫·放送/综艺部(婉音)是天然台长/主播圈，
//   民乐团(秦筝)供国风音频，轻小说同好会(苏墨墨)供有声书连载，躺平部(顾漫漫)供助眠白噪，万花镜打榜驱动声音榜。
// 全女性百合世界观，设定读绑定世界书。数据纯本地 _th_world_xmly_v1。
