...
export function openModal2(t:string,b:string){
...
export function commitAdd(basePath:string,name:string,payload:Record<string,any>, opts?:{onDuplicate?:'reject'|'overwrite'}): boolean {
