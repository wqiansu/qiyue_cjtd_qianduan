...
## 10.6 P1-A · 小剧场(`modules/world/theater.ts`)
...
## 10.7 P1-B · 世界论坛(`modules/world/forum.ts`)
...
> **设计补充储备(未做,后续可挑)**:微信——聊天时间分隔/未读红点置顶/引用回复·拍一拍/语音条降级/角色主动发消息;演化——时间线竖轴可视化/关系图/世界节拍总览/演化→微信联动(角色"想找你"生成待回复)/方向 chip 快捷填。整体——手机外壳/灵动岛/APP 切换转场;交互——键盘快捷键/右键菜单。**PC 端设计,不做移动端适配**(`feedback_pc_only_design`)。
